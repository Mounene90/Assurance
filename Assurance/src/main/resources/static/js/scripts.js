 ...
 */
function Grara() {
	var gara=document.getElementById('garantie').value;
	document.getElementById('primeBruteProrata').value=0;
	if(gara == 1)
	{
		var primeBruteProrata_1 = parseInt(primeBrute * 10);
	}
	document.getElementById('primeBruteProrata').value=primeBruteProrata_1;
}
function CalculeBC() {
...
var gara=document.getElementById('garantie').value;
/*var primeBruteProrata=document.getElementById('primeBruteProrata').value;*/
if(gara == 1)
{
	var primeBruteProrata_1 = parseInt(primeBrute * 10);
}
